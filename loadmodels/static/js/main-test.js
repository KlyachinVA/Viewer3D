...
function run(){
	...
	*/
	...
	init(id_viewport,objmodels,{color:"#ffffff",z_distance:30,ambient_light:false,fov:25})
...
function run2(){
	...
	first_2 = first_2?false:false
	*/
	let id_viewport = "viewport2"
	let models = [/*{path:'/static/models/buildings/kirha.fbx',
		                     scale:[0.01,0.01,0.01],
		                     position:[0,0,16],
		                     rotation:[0,0,0]
	...
	init(id_viewport,objmodels,{color:"#ffffff",z_distance:70,ambient_light:false,fov:25})
