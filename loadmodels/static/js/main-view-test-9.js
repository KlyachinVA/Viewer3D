...
function run(){
	...
	let objmodels = [[
							{path:'/static/models/buildings/circ3.obj',
							mtlpath:'/static/models/buildings/circ3.mtl',
							scale:[2.7,2.7,2.7],
							position:[8,4,-2],
							rotation:[0,3.14,0]
							}
							...
							[
							{
							path:'/static/models/buildings/cylinder.obj',
							mtlpath:'/static/models/buildings/cylinder.mtl',
							scale:[3.5,3.5,3.5],
							position:[-4,4,0],
							rotation:[0,3.14,0]
							},
